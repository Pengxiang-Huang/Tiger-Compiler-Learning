...
SLASH | STRING | COMMENT | SLASHF | INITIAL
...
fun yyAction17 (strm, lastMatch : yymatch) = let
      val yytext = yymktext(strm)
      in
        yystrm := strm; (Tokens.INT(getnum yytext,yypos,yypos+ size yytext))
      end
...
fun yyAction25 (strm, lastMatch : yymatch) = (yystrm := strm;
      (YYBEGIN COMMENT; comment_level := !comment_level+1; continue()))
fun yyAction26 (strm, lastMatch : yymatch) = (yystrm := strm;
      (comment_level := !comment_level+1; continue()))
fun yyAction27 (strm, lastMatch : yymatch) = (yystrm := strm;
      (if !comment_level = 1 then (YYBEGIN INITIAL; comment_level := !comment_level-1) else (comment_level := !comment_level-1); continue()))
fun yyAction28 (strm, lastMatch : yymatch) = (yystrm := strm;
      (lineNum := !lineNum+1; linePos := yypos :: !linePos; continue()))
fun yyAction29 (strm, lastMatch : yymatch) = (yystrm := strm; (continue()))
fun yyAction30 (strm, lastMatch : yymatch) = (yystrm := strm;
      (YYBEGIN STRING; mystr := "" ; stringstart := yypos ;continue()))
...
fun yyAction33 (strm, lastMatch : yymatch) = (yystrm := strm;
      ( mystr := !mystr ^ "\t"; continue()))
fun yyAction34 (strm, lastMatch : yymatch) = (yystrm := strm;
      ( mystr := !mystr ^ "\r"; continue()))
...
fun yyAction37 (strm, lastMatch : yymatch) = let
      ...
      in
        yystrm := strm;
        (let val asci_char = getddd yytext in mystr := !mystr ^ asci_char end; continue())
      end
fun yyAction38 (strm, lastMatch : yymatch) = let
      val yytext = yymktext(strm)
      in
        yystrm := strm;
        (let val asci_char = getcontrol yytext in mystr := !mystr ^ asci_char end; continue())
      end
...
fun yyAction43 (strm, lastMatch : yymatch) = let
      val yytext = yymktext(strm)
      in
        yystrm := strm; (mystr := !mystr ^ yytext; continue())
      end
fun yyAction44 (strm, lastMatch : yymatch) = (yystrm := strm;
      (YYBEGIN INITIAL; Tokens.STRING(!mystr,!stringstart,yypos) ))
fun yyAction45 (strm, lastMatch : yymatch) = (yystrm := strm; (continue()))
fun yyAction46 (strm, lastMatch : yymatch) = (yystrm := strm;
      (YYBEGIN STRING; continue()))
fun yyAction47 (strm, lastMatch : yymatch) = (yystrm := strm;
      (YYBEGIN SLASHF; continue()))
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction1(strm, yyNO_MATCH)
                      else yyQ76(strm', yyMATCH(strm, yyAction1, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction1(strm, yyNO_MATCH)
                  else yyQ76(strm', yyMATCH(strm, yyAction1, yyNO_MATCH))
            else if inp = #"`"
       ...
       of NONE => yyAction18(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ79(strm', yyMATCH(strm, yyAction18, yyNO_MATCH))
            else if inp < #"l"
              then if inp = #"`"
                  then yyAction18(strm, yyNO_MATCH)
                  else yyQ76(strm', yyMATCH(strm, yyAction18, yyNO_MATCH))
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction0(strm, yyNO_MATCH)
                      else yyQ76(strm', yyMATCH(strm, yyAction0, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction0(strm, yyNO_MATCH)
                  else yyQ76(strm', yyMATCH(strm, yyAction0, yyNO_MATCH))
            else if inp = #"`"
              ...
              then if inp = #"_"
                  then yyQ76(strm', yyMATCH(strm, yyAction0, yyNO_MATCH))
       ...
       of NONE => yyAction18(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then if inp = #"`"
                  then yyAction18(strm, yyNO_MATCH)
                  else yyQ81(strm', yyMATCH(strm, yyAction18, yyNO_MATCH))
            else if inp <= #"z"
              then yyQ76(strm', yyMATCH(strm, yyAction18, yyNO_MATCH))
              else yyAction18(strm, yyNO_MATCH)
      (* end case *))
       ...
       of NONE => yyAction18(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ88(strm', yyMATCH(strm, yyAction18, yyNO_MATCH))
            else if inp < #"e"
              then if inp = #"`"
                  then yyAction18(strm, yyNO_MATCH)
                  else yyQ76(strm', yyMATCH(strm, yyAction18, yyNO_MATCH))
       ...
       of NONE => yyAction18(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ92(strm', yyMATCH(strm, yyAction18, yyNO_MATCH))
            else if inp < #"l"
              then if inp = #"`"
                  then yyAction18(strm, yyNO_MATCH)
                  else yyQ76(strm', yyMATCH(strm, yyAction18, yyNO_MATCH))
       ...
       of NONE => yyAction18(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ94(strm', yyMATCH(strm, yyAction18, yyNO_MATCH))
            else if inp < #"t"
              then if inp = #"`"
                  then yyAction18(strm, yyNO_MATCH)
                  else yyQ76(strm', yyMATCH(strm, yyAction18, yyNO_MATCH))
       ...
       of NONE => yyAction18(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ104(strm', yyMATCH(strm, yyAction18, yyNO_MATCH))
            else if inp < #"n"
              then if inp = #"`"
                  then yyAction18(strm, yyNO_MATCH)
                  else yyQ76(strm', yyMATCH(strm, yyAction18, yyNO_MATCH))
       ...
       of NONE => yyAction18(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ103(strm', yyMATCH(strm, yyAction18, yyNO_MATCH))
            else if inp < #"o"
              then if inp = #"`"
                  then yyAction18(strm, yyNO_MATCH)
                  else yyQ76(strm', yyMATCH(strm, yyAction18, yyNO_MATCH))
       ...
       of NONE => yyAction18(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ102(strm', yyMATCH(strm, yyAction18, yyNO_MATCH))
            else if inp < #"i"
              then if inp = #"`"
                  then yyAction18(strm, yyNO_MATCH)
                  else yyQ76(strm', yyMATCH(strm, yyAction18, yyNO_MATCH))
       ...
       of NONE => yyAction18(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ101(strm', yyMATCH(strm, yyAction18, yyNO_MATCH))
            else if inp < #"t"
              then if inp = #"`"
                  then yyAction18(strm, yyNO_MATCH)
                  else yyQ76(strm', yyMATCH(strm, yyAction18, yyNO_MATCH))
       ...
       of NONE => yyAction18(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ100(strm', yyMATCH(strm, yyAction18, yyNO_MATCH))
            else if inp < #"c"
              then if inp = #"`"
                  then yyAction18(strm, yyNO_MATCH)
                  else yyQ76(strm', yyMATCH(strm, yyAction18, yyNO_MATCH))
       ...
       of NONE => yyAction18(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ99(strm', yyMATCH(strm, yyAction18, yyNO_MATCH))
            else if inp < #"n"
              then if inp = #"`"
                  then yyAction18(strm, yyNO_MATCH)
                  else yyQ76(strm', yyMATCH(strm, yyAction18, yyNO_MATCH))
       ...
       of NONE => yyAction18(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ105(strm', yyMATCH(strm, yyAction18, yyNO_MATCH))
            else if inp < #"r"
              then if inp = #"`"
                  then yyAction18(strm, yyNO_MATCH)
                  else yyQ76(strm', yyMATCH(strm, yyAction18, yyNO_MATCH))
       ...
       of NONE => yyAction18(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ108(strm', yyMATCH(strm, yyAction18, yyNO_MATCH))
            else if inp < #"d"
              then if inp = #"`"
                  then yyAction18(strm, yyNO_MATCH)
                  else yyQ76(strm', yyMATCH(strm, yyAction18, yyNO_MATCH))
       ...
       of NONE => yyAction18(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ110(strm', yyMATCH(strm, yyAction18, yyNO_MATCH))
            else if inp < #"e"
              then if inp = #"`"
                  then yyAction18(strm, yyNO_MATCH)
                  else yyQ76(strm', yyMATCH(strm, yyAction18, yyNO_MATCH))
       ...
       of NONE => yyAction18(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"`"
              ...
              then yyQ107(strm', yyMATCH(strm, yyAction18, yyNO_MATCH))
            else if inp < #"n"
              then if inp = #"l"
                  then yyQ106(strm', yyMATCH(strm, yyAction18, yyNO_MATCH))
                  else yyQ76(strm', yyMATCH(strm, yyAction18, yyNO_MATCH))
            else if inp <= #"z"
              then yyQ76(strm', yyMATCH(strm, yyAction18, yyNO_MATCH))
              else yyAction18(strm, yyNO_MATCH)
       ...
       of NONE => yyAction18(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ111(strm', yyMATCH(strm, yyAction18, yyNO_MATCH))
            else if inp < #"o"
              then if inp = #"`"
                  then yyAction18(strm, yyNO_MATCH)
                  else yyQ76(strm', yyMATCH(strm, yyAction18, yyNO_MATCH))
       ...
       of NONE => yyAction18(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ115(strm', yyMATCH(strm, yyAction18, yyNO_MATCH))
            else if inp < #"k"
              then if inp = #"`"
                  then yyAction18(strm, yyNO_MATCH)
                  else yyQ76(strm', yyMATCH(strm, yyAction18, yyNO_MATCH))
       ...
       of NONE => yyAction18(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then if inp = #"`"
                  then yyAction18(strm, yyNO_MATCH)
                  else yyQ114(strm', yyMATCH(strm, yyAction18, yyNO_MATCH))
            else if inp <= #"z"
              then yyQ76(strm', yyMATCH(strm, yyAction18, yyNO_MATCH))
              else yyAction18(strm, yyNO_MATCH)
      (* end case *))
       ...
       of NONE => yyAction18(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ112(strm', yyMATCH(strm, yyAction18, yyNO_MATCH))
            else if inp < #"r"
              then if inp = #"`"
                  then yyAction18(strm, yyNO_MATCH)
                  else yyQ76(strm', yyMATCH(strm, yyAction18, yyNO_MATCH))
       ...
       of NONE => yyAction18(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ119(strm', yyMATCH(strm, yyAction18, yyNO_MATCH))
            else if inp < #"y"
              then if inp = #"`"
                  then yyAction18(strm, yyNO_MATCH)
                  else yyQ76(strm', yyMATCH(strm, yyAction18, yyNO_MATCH))
       ...
       of NONE => yyAction18(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then if inp = #"`"
                  then yyAction18(strm, yyNO_MATCH)
                  else yyQ118(strm', yyMATCH(strm, yyAction18, yyNO_MATCH))
            else if inp <= #"z"
              then yyQ76(strm', yyMATCH(strm, yyAction18, yyNO_MATCH))
              else yyAction18(strm, yyNO_MATCH)
      (* end case *))
       ...
       of NONE => yyAction18(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ117(strm', yyMATCH(strm, yyAction18, yyNO_MATCH))
            else if inp < #"r"
              then if inp = #"`"
                  then yyAction18(strm, yyNO_MATCH)
                  else yyQ76(strm', yyMATCH(strm, yyAction18, yyNO_MATCH))
       ...
       of NONE => yyAction18(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ116(strm', yyMATCH(strm, yyAction18, yyNO_MATCH))
            else if inp < #"r"
              then if inp = #"`"
                  then yyAction18(strm, yyNO_MATCH)
                  else yyQ76(strm', yyMATCH(strm, yyAction18, yyNO_MATCH))
       ...
       of NONE => yyAction73(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"r"
              ...
              then if inp = #"n"
                  then yyAction73(strm, yyNO_MATCH)
                  else yyQ120(strm', yyMATCH(strm, yyAction73, yyNO_MATCH))
            else if inp = #"t"
              then yyAction73(strm, yyNO_MATCH)
              else yyQ120(strm', yyMATCH(strm, yyAction73, yyNO_MATCH))
      (* end case *))
...
fun yyQ56 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction68(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"="
              then yyQ121(strm', yyMATCH(strm, yyAction68, yyNO_MATCH))
       ...
       of NONE => yyAction66(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #">"
              ...
              then if inp = #"="
                  then yyQ122(strm', yyMATCH(strm, yyAction66, yyNO_MATCH))
...
fun yyQ50 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction63(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"*"
              then yyQ126(strm', yyMATCH(strm, yyAction63, yyNO_MATCH))
...
fun yyQ34 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction48(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"\\"
              then yyQ35(strm', yyMATCH(strm, yyAction48, yyNO_MATCH))
        ...
        | SOME(inp, strm') =>
            if inp = #"]"
              ...
              then if inp = #"!"
                  ...
                  then yyQ17(strm', yyMATCH(strm, yyAction43, yyNO_MATCH))
                else if inp < #"0"
                  then if inp = #"\""
...
in
  (case (!(yyss))
   of SLASH => yyQ0(!(yystrm), yyNO_MATCH)
    | STRING => yyQ1(!(yystrm), yyNO_MATCH)
    | COMMENT => yyQ2(!(yystrm), yyNO_MATCH)
    | SLASHF => yyQ3(!(yystrm), yyNO_MATCH)
